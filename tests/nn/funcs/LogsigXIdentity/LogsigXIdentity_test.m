...
pDerPoint = plot3(xl, yl, LogsigXIdentity.f(xl, yl), '*y','LineWidth',4);
pDerPoint = plot3(xu, yu, LogsigXIdentity.f(xu, yu), '*m','LineWidth',4);
pDerPoint = plot3(xu, yl, LogsigXIdentity.f(xu, yl), '*c','LineWidth',4);
pDerPoint = plot3(xl, yu, LogsigXIdentity.f(xl, yu), '*g','LineWidth',4);


[U_x, U_y, U_b, L_x, L_y, L_b, zmax, zmin] = LogsigXIdentity.getConstraints(xl, xu, yl, yu);
